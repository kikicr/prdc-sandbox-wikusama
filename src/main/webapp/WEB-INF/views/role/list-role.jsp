			...
			<table>
				...
				<caption>
					...
					<div class="medium-8 columns">
						<a href="<spring:url value="/role-manager/add/" />"
				...
				<tbody>
					<c:forEach items="${roleList}" var="role">
						<tr>
							...
							<td><a class="button tiny" href="<spring:url value='/role-manager/edit/${role.id}'/>">
								<i class="fa fa-edit"></i> edit</a> 
									<a class="button alert tiny hapus" id="<spring:url value='/role-manager/delete/${role.id}'/>::${role.id}">
								<i class="fa fa-eraser"></i> delete</a></td>
							<td></td>
						</tr>
					</c:forEach>
				</tbody>
