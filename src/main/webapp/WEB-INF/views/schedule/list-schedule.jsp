			...
			<table>
				...
				<caption>
					...
					<div class="medium-8 columns">
						<a href="<spring:url value="/schedule-manager/add/" />"
				...
				<tbody>
					<c:forEach items="${scheduleList}" var="schedule">
						<tr>
							...
							<td>${schedule.section.startAt}</td>
							<td>${schedule.section.endAt}</td>
							<td>${schedule.room.name}</td>
							<td>${schedule.room.capacity}</td>
							<td><a class="button tiny"
								href="<spring:url value='/room-manager/edit/${schedule.id}'/>"><i
									class="fa fa-edit"></i> edit</a> <a class="button alert tiny hapus"
								id="<spring:url value='/room-manager/delete/${schedule.id}::${schedule.id}'/>"><i
