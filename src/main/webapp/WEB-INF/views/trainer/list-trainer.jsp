			...
			<table>
				...
				<caption>
					...
					<div class="medium-8 columns">
						<a href="<spring:url value="/trainer-manager/add/" />"
				...
				<tbody>
					<c:forEach items="${trainerList}" var="trainer">
						<tr>
							...
							<td>${trainer.workAt}</td>
							<td>${trainer.quote}</td>
							<td><a class="button tiny"
								href="<spring:url value='/trainer-manager/edit/${trainer.id}'/>"><i
									class="fa fa-edit"></i> edit</a> <a class="button alert tiny hapus"
								id="<spring:url value='/trainer-manager/delete/${trainer.id}::${trainer.id}'/>"><i
