...
<body>
	<div class="row">
		<div class="large-11 columns">
			<spring:url value="/room-manager/add/" var="url"></spring:url>
			<c:if test="${isEdit}" >
			<spring:url value="/room-manager/do-edit/${room.id}" var="url"></spring:url>
			</c:if>
			<form:form commandName="room" action="${url}" method="post">
				<div class="row">
