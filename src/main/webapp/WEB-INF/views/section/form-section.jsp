...
<body>
	<div class="row">
		<div class="large-11 columns">
			<spring:url value="/section-manager/add/" var="url"></spring:url>
			<c:if test="${isEdit}">
				<spring:url value="/section-manager/do-edit/${section.id}" var="url"></spring:url>
			</c:if>
			<form:form commandName="section" action="${url}" method="post">
				<div class="row">
