  ...
  <section class="top-bar-section">
    ...
    <ul class="right">
    	<li class="has-form" id="login-has">
     	<a href="<c:url value='/j_spring_security_logout'/>" id="btn-login" class="alert button" ><i class="fa fa-close"></i> Sign out</a>	
    	</li>
    </ul>
  </section>
</nav>
			...
			<table>
				...
				<caption>
					...
					<div class="medium-8 columns" >
						<a href="<spring:url value="/lesson-manager/add/" />"
							class="button success tiny"><i class="fa fa-plus"></i> add</a>
							<a href="<spring:url value="/report/pdf" />"
							class="button success tiny"><i class="fa fa-print"></i> to PDF</a>
					</div>
				</caption>
				<th>Lesson ID</th>
				<th>Lesson Name</th>
					...
					<c:forEach items="${LessonList}" var="lesson">
						<tr>
							...
							<td><a class="button tiny"
								href="<spring:url value='/lesson-manager/edit/${lesson.id}'/>"><i
									class="fa fa-edit"></i> edit</a> <a class="button alert tiny hapus"
								id="<spring:url value='/lesson-manager/delete/${lesson.id}::${lesson.id}'/>"><i
